    ...
    */
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_sport_F", 65750, { "driver" }, { "", "", -1 } },
            { "C_Van_01_transport_F", 80000, { "driver" }, { "", "", -1 } }
        };
    };
    ...
    class med_shop {
        side = "med";
        vehicles[] = {
            { "B_G_Offroad_01_repair_F", 10000, { "" }, { "", "", -1 } },
            { "C_SUV_01_F", 25000, { "" }, { "", "", -1 } },
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "B_MRAP_01_F", 200000, { "" }, { "life_coplevel", "SCALAR", 5 } }
        };
    };
