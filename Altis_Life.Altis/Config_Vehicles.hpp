class CarShops {
    ...
    */
    class civ_car {
        side = "civ";
        vehicles[] = {
            { "B_Quadbike_01_F", 300, { "" }, { "", "", -1 } },
            { "C_Hatchback_01_F", 12750, { "driver" }, { "", "", -1 } },
            { "C_Offroad_01_F", 18000, { "driver" }, { "", "", -1 } },
            { "C_SUV_01_F", 30000, { "driver" }, { "", "", -1 } },
            { "C_Hatchback_01_sport_F", 42750, { "driver" }, { "", "", -1 } },
    ...
    class med_shop {
        ...
        vehicles[] = {
            ...
            { "C_SUV_01_F", 25000, { "" }, { "", "", -1 } },
            { "C_Hatchback_01_sport_F", 65000, { "" }, { "", "", -1 } }
        };
    };
    ...
    class med_air_hs {
        ...
        vehicles[] = {
			...
			{ "I_Heli_light_03_unarmed_F", 114000,{ "mAir" }, { "", "", -1 } }
        };
    };
    ...
    class civ_truck {
        side = "civ";
        vehicles[] = {
            { "O_G_Van_01_fuel_F", 65000, { "trucking" }, { "", "", -1 } },
            { "C_Van_01_box_F", 87000, { "trucking" }, { "", "", -1 } },
            { "O_Truck_02_transport_F", 125000, { "trucking" }, { "", "", -1 } },
            { "I_Truck_02_covered_F", 150000, { "trucking" }, { "", "", -1 } },
            { "O_Truck_03_transport_F", 400000, { "trucking" }, { "", "", -1 } },
			{ "O_Truck_03_device_F", 550000, { "trucking" }, { "", "", -1 } }
        };
    };
    ...
    class reb_car {
        side = "civ";
        vehicles[] = {
            { "B_Quadbike_01_F", 500, { "" }, { "", "", -1 } },
            { "B_G_Offroad_01_F", 17000, { "" }, { "", "", -1 } },
            { "O_MRAP_02_F", 250000, { "rebel" }, { "", "", -1 } },
            { "B_G_Offroad_01_armed_F", 450000, { "rebel" }, { "", "", -1 } },
			{ "O_Truck_03_fuel_F", 325000, { "" }, { "", "", -1 } }
        };
    };
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "C_SUV_01_F", 7000, { "" }, { "life_coplevel", "SCALAR", 2 } },
			{ "C_Hatchback_01_sport_F", 9000, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "B_MRAP_01_F", 95000, { "" }, { "life_coplevel", "SCALAR", 5 } }
        };
    };
    ...
    class civ_air {
        side = "civ";
        vehicles[] = {
            { "B_Heli_Light_01_F", 90000, { "pilot" }, { "", "", -1 } },
            { "O_Heli_Light_02_unarmed_F", 150000, { "pilot" }, { "", "", -1 } },
			{ "I_Heli_light_03_unarmed_F", 175000, { "pilot" }, { "", "", -1 } }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Light_01_F", 90000, { "cAir" }, { "life_coplevel", "SCALAR", 4 } },
            { "O_Heli_Light_02_unarmed_F", 160000, { "cAir" }, { "life_coplevel", "SCALAR", 5 } },
			{ "I_Heli_light_03_unarmed_F", 175000, { "cAir" }, { "life_coplevel", "SCALAR", 6 } }
        };
    };
    ...
    class cop_airhq {
        side = "civ";
        vehicles[] = {
            { "B_Heli_Transport_01_F", 40000, { "cAir" }, { "life_coplevel", "SCALAR", 4 } }
        };
    };
    ...
    class cop_ship {
        side = "cop";
        vehicles[] = {
            { "B_Boat_Transport_01_F", 3000, { "cg" }, { "life_coplevel", "SCALAR", 3 } },
            { "C_Boat_Civil_01_police_F", 20000, { "cg" }, { "life_coplevel", "SCALAR", 3 } }
        };
    };
    ...
    */
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "Cop", "cop", {
                "textures\cop\apd_hatchback.paa"
			} },
            { "EMS White", "med", {
    ...
    class B_MRAP_01_F {
        ...
        textures[] = {
            { "Cop", "cop", {
                "textures\cop\apd_hfront.paa",
				"textures\cop\apd_hback.paa"
            } }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            ...
            { "EMS White", "med", {
                "textures\med\ems_hummingbird.paa"
			} },
            { "Cop", "cop", {
                "textures\cop\apd_hummingbird.paa"
            } }
        };
    };
    ...
    class O_Heli_Light_02_unarmed_F {
        vItemSpace = 100;
        storageFee[] = { 500, 0, 200, 0 };
        garageSell[] = { 100, 0, 100, 0 };
        insurance = 2500;
        chopShop = 5000;
        textures[] = {
            { "White / Blue", "civ", {
           ...
           { "Cop", "cop", {
                "textures\cop\apd_orca.paa"
            } },
            { "Desert Digi", "reb", {
                "\a3\air_f\Heli_Light_02\Data\heli_light_02_ext_opfor_co.paa"
            } },
            { "EMS White", "med", {
                "textures\med\ems_orca.paa"
            } }
        };
    };
    ...
    class I_Heli_light_03_unarmed_F {
        ...
        textures[] = {
            ...
            { "EMS White", "med", {
                "textures\med\ems_hellcat.paa.paa"
            } }
        };
    };
};
